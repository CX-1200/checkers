// *********************************************************
// Program: TC1L_G12_main.cpp
// Course: CCP6114 Programming Fundamentals
// Lecture Class: TC1L
// Tutorial Class: TT4L
// Trimester: 2610
// Information : 261UC2600N | LIM CHEN XIANG | lim.chen.xiang@student.mmu.edu.my | +(60)12 - 201 4067
// *********************************************************
...
void doTeleport(GameData& data, GamePiece& piece, int kingRow, int kingCol)
{
    ...
    if (destinationRow < 0 || destinationRow >= data.boardSize || destinationRow < 0 || destinationCol >= data.boardSize
...
void powerTutorial() 
{
    ...
    cout << "    R  Resurrect   - bring back up to 2 captured men beside it." << endl;
